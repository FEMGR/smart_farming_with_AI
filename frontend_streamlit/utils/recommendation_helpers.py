"""
Utility functions for processing and presenting companion planting recommendations in the frontend_streamlit.
...
Layer Interaction:
- Communicates with: `frontend_streamlit/pages/recommendations.py` (for data processing).
...
# frontend_streamlit/utils/recommendation_helpers.py
