"""
Utility functions for formatting and display in the frontend_streamlit.
...
Architecture Role:
- Centralizes common formatting logic to ensure consistency across the frontend_streamlit.
...
# frontend_streamlit/utils/formatting.py
