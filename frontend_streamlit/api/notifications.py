...
allowing the frontend_streamlit to retrieve user notifications and mark them as read.
...
Architecture Role:
- Acts as a dedicated interface for the frontend_streamlit to manage notification data on the backend.
...
Backend processes the request and returns a list of notifications
        ↓
List of notifications is returned to the frontend_streamlit UI for display
...
# frontend_streamlit/api/notifications.py
