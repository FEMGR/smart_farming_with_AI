...
Architecture Role:
- Acts as a dedicated interface for the frontend_streamlit to retrieve species data from the backend.
...
Backend processes the query and returns a list of matching species suggestions
        ↓
List of species suggestions is returned to the frontend_streamlit UI for display
"""

# frontend_streamlit/api/species.py
