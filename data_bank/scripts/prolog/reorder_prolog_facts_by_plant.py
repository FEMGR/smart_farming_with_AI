...
Design:
    ...
    - Writes previews to data_bank/data_bank/prolog_preview by default.
"""
...
AUTO_ORGANIZED_LINE = "% Auto-organized by data_bank/scripts/prolog/reorder_prolog_facts_by_plant.py"
...
def main() -> None:
    ...
    parser.add_argument(
        "--preview-dir",
        default="data_bank/data_bank/prolog_preview",
