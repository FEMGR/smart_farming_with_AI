"""Train, evaluate, compare, and persist Computer Vision pest detection models."""

# ai/tasks/pest_detection/train.py
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Manager for Pest Detection Vision Models")
