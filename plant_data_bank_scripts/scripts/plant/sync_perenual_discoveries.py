...
Run:
python3 plant_data_bank_scripts/scripts/plant/sync_perenual_discoveries.py --show-paths

Or with missing extraction:
python3 plant_data_bank_scripts/scripts/plant/sync_perenual_discoveries.py \
  --extract-missing \
  --dry-run
