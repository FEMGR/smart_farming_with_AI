...
alternate_scientific_name(aloe_vera, 'Aloe barbadensis, Aloe vulgaris').
genus(aloe_vera, aloe).
family(aloe_vera, asphodelaceae).
taxonomy_confidence(aloe_vera, high).
taxonomy_source(aloe_vera, 'GBIF / Plants For A Future').
...
taxonomy_source(apple, 'GBIF / Plants For A Future').
...
taxonomy_source(artichoke, 'GBIF / Plants For A Future').
...
alternate_scientific_name(arugula, 'Euzomum vesicarium () Link').
alternate_scientific_name(arugula, 'Heterotypic Synonyms: E').
alternate_scientific_name(arugula, 'Homotypic Synonyms: Brassica vesicaria E').
alternate_scientific_name(arugula, 'Raphanus vesicarius () Crantz').
alternate_scientific_name(arugula, 'Velleruca vesicaria () Pomel').
genus(arugula, eruca).
family(arugula, brassicaceae).
taxonomy_confidence(arugula, high).
taxonomy_source(arugula, 'GBIF / Plants For A Future').
...
alternate_scientific_name(basil, 'Ocimum album, Ocimum anisatum, Ocimum barrelieri, Ocimum medium, Plectranthus barrelieri').
genus(basil, ocimum).
family(basil, lamiaceae).
taxonomy_confidence(basil, high).
taxonomy_source(basil, 'GBIF / Plants For A Future').
...
taxonomy_confidence(bean_common, high).
taxonomy_source(bean_common, 'GBIF / Plants For A Future').
...
taxonomy_source(bitter_melon, 'GBIF / Plants For A Future').
...
taxonomy_confidence(blackberry, high).
taxonomy_confidence(blackberry, medium).
taxonomy_source(blackberry, 'GBIF / Plants For A Future').
...
taxonomy_source(bok_choy, 'GBIF / Plants For A Future').
...
taxonomy_source(broccoli, 'GBIF / Plants For A Future').
...
taxonomy_source(cabbage, 'GBIF / Plants For A Future').
...
taxonomy_source(carrot, 'GBIF / Plants For A Future').
...
taxonomy_source(cauliflower, 'GBIF / Plants For A Future').
...
alternate_scientific_name(celery, 'Apium celleri').
alternate_scientific_name(celery, 'Apium decumbens').
alternate_scientific_name(celery, 'Carum graveolens').
alternate_scientific_name(celery, 'Celeria graveolens').
genus(celery, apium).
family(celery, apiaceae).
taxonomy_confidence(celery, high).
taxonomy_source(celery, 'GBIF / Plants For A Future').
...
taxonomy_source(chickpea, 'GBIF / Plants For A Future').
...
taxonomy_confidence(chicory, high).
taxonomy_source(chicory, 'GBIF / Plants For A Future').
...
taxonomy_source(chive, 'GBIF / Plants For A Future').
...
taxonomy_confidence(coriander, high).
taxonomy_source(coriander, 'GBIF / Plants For A Future').
...
taxonomy_source(cucumber, 'GBIF / Plants For A Future').
...
taxonomy_confidence(dandelion, high).
taxonomy_confidence(dandelion, medium).
taxonomy_source(dandelion, 'GBIF / Plants For A Future').
...
taxonomy_source(dill, 'GBIF / Plants For A Future').
...
taxonomy_source(eggplant, 'GBIF / Plants For A Future').
...
alternate_scientific_name(fennel, 'Anethum dulce').
alternate_scientific_name(fennel, 'Anethum foeniculum').
alternate_scientific_name(fennel, 'Foeniculum divaricatum').
alternate_scientific_name(fennel, 'Foeniculum officinale').
alternate_scientific_name(fennel, 'Seseli foeniculum').
genus(fennel, foeniculum).
family(fennel, apiaceae).
taxonomy_confidence(fennel, high).
taxonomy_source(fennel, 'GBIF / Plants For A Future').
...
taxonomy_source(fig, 'GBIF / Plants For A Future').
...
taxonomy_source(galangal, 'GBIF / Plants For A Future').
...
taxonomy_source(garlic, 'GBIF / Plants For A Future').
...
alternate_scientific_name(ginger, 'Amomum angustifolium Salisb').
alternate_scientific_name(ginger, 'Amomum zingiber Amomum zinziba Hill Zingiber aromaticum Noronha Zing').
genus(ginger, zingiber).
family(ginger, zingiberaceae).
taxonomy_confidence(ginger, high).
taxonomy_source(ginger, 'GBIF / Plants For A Future').
...
taxonomy_source(grape, 'GBIF / Plants For A Future').
...
taxonomy_confidence(kale, high).
taxonomy_confidence(kale, medium).
taxonomy_source(kale, 'GBIF / Plants For A Future').
...
taxonomy_source(lavender, 'GBIF / Plants For A Future').
...
taxonomy_source(leek, 'GBIF / Plants For A Future').
...
alternate_scientific_name(lemon_balm, 'Faucibarba officinalis').
alternate_scientific_name(lemon_balm, 'Mutelia officinalis').
alternate_scientific_name(lemon_balm, 'Thymus melissa').
genus(lemon_balm, melissa).
family(lemon_balm, lamiaceae).
taxonomy_confidence(lemon_balm, high).
taxonomy_source(lemon_balm, 'GBIF / Plants For A Future').
...
taxonomy_source(lentil, 'GBIF / Plants For A Future').
...
taxonomy_source(lettuce, 'GBIF / Plants For A Future').
...
taxonomy_source(melon, 'GBIF / Plants For A Future').
...
alternate_scientific_name(moringa, 'Guilandina moringa Hyperanthera moringa () Vahl Moringa moringa () Millsp').
alternate_scientific_name(moringa, 'Moringa pterygospe').
genus(moringa, moringa).
family(moringa, moringaceae).
taxonomy_confidence(moringa, high).
taxonomy_source(moringa, 'GBIF / Plants For A Future').
...
alternate_scientific_name(onion, 'Allium angolense, Allium aobanum, Allium ascalonicum, Cepa esculenta').
genus(onion, allium).
family(onion, amaryllidaceae).
taxonomy_confidence(onion, high).
taxonomy_source(onion, 'GBIF / Plants For A Future').
...
taxonomy_source(oregano, 'GBIF / Plants For A Future').
...
alternate_scientific_name(parsley, 'Petroselinum petroselinum').
alternate_scientific_name(parsley, 'Petroselinum vulgare').
alternate_scientific_name(parsley, 'Selinum petroselinum').
genus(parsley, petroselinum).
family(parsley, apiaceae).
taxonomy_confidence(parsley, high).
taxonomy_source(parsley, 'GBIF / Plants For A Future').
...
taxonomy_source(pea, 'GBIF / Plants For A Future').
...
alternate_scientific_name(peanut, 'Arachis nambyquarae').
alternate_scientific_name(peanut, 'Lathyrus esquirolii').
genus(peanut, arachis).
family(peanut, fabaceae).
taxonomy_confidence(peanut, high).
taxonomy_source(peanut, 'GBIF / Plants For A Future').
...
taxonomy_source(pear, 'GBIF / Plants For A Future').
...
taxonomy_confidence(peppermint, high).
taxonomy_source(peppermint, 'GBIF / Plants For A Future').
...
alternate_scientific_name(potato, 'Solanum tuberosum andigena').
genus(potato, solanum).
family(potato, solanaceae).
taxonomy_confidence(potato, high).
taxonomy_source(potato, 'GBIF / Plants For A Future').
...
taxonomy_confidence(pumpkin, high).
taxonomy_confidence(pumpkin, medium).
taxonomy_source(pumpkin, 'GBIF / Plants For A Future').
...
taxonomy_source(radish, 'GBIF / Plants For A Future').
...
taxonomy_confidence(raspberry, high).
taxonomy_confidence(raspberry, medium).
taxonomy_source(raspberry, 'GBIF / Plants For A Future').
...
taxonomy_source(rosemary, 'GBIF / Plants For A Future').
...
taxonomy_source(sage, 'GBIF / Plants For A Future').
...
taxonomy_source(soybean, 'GBIF / Plants For A Future').
...
taxonomy_confidence(spearmint, high).
taxonomy_source(spearmint, 'GBIF / Plants For A Future').
...
taxonomy_source(strawberry, 'GBIF / Plants For A Future').
...
taxonomy_source(sunflower, 'GBIF / Plants For A Future').
...
taxonomy_source(sweet_potato, 'GBIF / Plants For A Future').
...
alternate_scientific_name(thyme, 'Origanum thymus Kuntze').
alternate_scientific_name(thyme, 'Thymus collinus Salisb').
genus(thyme, thymus).
family(thyme, lamiaceae).
taxonomy_confidence(thyme, high).
taxonomy_source(thyme, 'GBIF / Plants For A Future').
...
alternate_scientific_name(tomato, 'Lycopersicon cerasiforme Dunal Lycopersicon esculentum Mill').
alternate_scientific_name(tomato, 'Lycopersicon esculentum').
alternate_scientific_name(tomato, 'Lycopersicon humboldtii (Willd').
genus(tomato, solanum).
family(tomato, solanaceae).
taxonomy_confidence(tomato, high).
taxonomy_source(tomato, 'GBIF / Plants For A Future').
...
taxonomy_source(turmeric, 'GBIF / Plants For A Future').
...
taxonomy_source(turnip, 'GBIF / Plants For A Future').
...
taxonomy_source(watermelon, 'GBIF / Plants For A Future').
...
taxonomy_confidence(zucchini, high).
taxonomy_source(zucchini, 'GBIF / Plants For A Future').
